...
We will however setup a ECR and provide a user so developers can upload their own image to test their changes on our environment so we can make sure it will work in prod.
...
5. Barebone legal stuff for 50% profit sharing agreement, license usage, onboarding/offboarding process with 1-3 month notice period, ..
